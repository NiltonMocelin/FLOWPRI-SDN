...
#    tcp.bind((socket.gethostbyname(socket.gethostname()),4444))
    ...
    while True:
        ...
        #verificar se ja nao existe um contrato identico - nao recriar [nao implementado]
...
#        t1.join()
    ...
    def switch_features_handler(self, ev):
        ...
        logging.info('[switch_features] inicio settage - tempo: %d\n' % (round(time.monotonic()*1000)))
...
####### etapa 5 - reijetar icmp 15
    ...
    ############################
        ...
        ###### (i) sou o controlador de destino
                if ip_dst == IPC:
                    logging.info('[Packet_In] icmp 16 - controlador destino - inicio - tempo: %d\n' % (round(time.monotonic()*1000)))

...
sudo ovs-vsctl -- set port s1-eth4 qos=@newqos -- --id=@newqos create qos type=linux-htb other-config:max-rate=10000000 queues=0=@q0,1=@q1,2=@q2,3=@q3,4=@q4,5=@q5,6=@q6,7=@q7 -- --id=@q0 create queue other-config:min-rate=0 other-config:max-rate=3300000 other-config:priority=10 -- --id=@q1 create queue other-config:min-rate=0 other-config:max-rate=3300000 other-config:priority=5 -- --id=@q2 create queue other-config:min-rate=0 other-config:max-rate=3300000 other-config:priority=2 -- --id=@q3 create queue other-config:min-rate=0 other-config:max-rate=3500000 other-config:priority=10 -- --id=@q4 create queue other-config:min-rate=0 other-config:max-rate=3500000 other-config:priority=5 -- --id=@q5 create queue other-config:min-rate=0 other-config:max-rate=3500000 other-config:priority=2 -- --id=@q6 create queue other-config:min-rate=2500000 other-config:max-rate=2500000 other-config:priority=1 -- --id=@q7 create queue other-config:min-rate=700000 other-config:max-rate=700000 other-config:priority=1

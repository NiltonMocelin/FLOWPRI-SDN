...
####USANDO METER
        ...
        req = parser.OFPMeterMod(datapath=datapath, command=ofproto.OFPMC_ADD, flags=ofproto.OFPMF_KBPS, meter_id=22, bands=bands)
        datapath.send_msg(req)

        bands = [parser.OFPMeterBandDrop(rate=100)]
        req = parser.OFPMeterMod(datapath=datapath, meter_id=22, bands=bands)
        datapath.send_msg(req)

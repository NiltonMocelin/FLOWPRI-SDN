...
#    CONTROLLER_IP_HOST = '172.16.10.1' # assim nao funcionou
    ...
    s4 = net.addSwitch( 's4', listenPort=6637, mac='00:00:00:00:00:04', dpid='0000000000000004',protocols="OpenFlow10,OpenFlow12,OpenFlow13")
    ...
    intfh1 = net.addLink(h1, s1, port2=1, bw=10, delay='15ms', loss=0, max_queue_size=1000, use_htb=True).intf1
    intfh2 = net.addLink(h2, s1, port2=2, bw=10, delay='15ms', loss=0, max_queue_size=1000, use_htb=True).intf1
    intfh3 = net.addLink(h3, s1, port2=3, bw=10, delay='15ms', loss=0, max_queue_size=1000, use_htb=True).intf1

    intfh4 = net.addLink(h4, s5, port2=1, bw=10, delay='15ms', loss=0, max_queue_size=1000, use_htb=True).intf1

    net.addLink(s1, s2, port1=4, port2=2, bw=15, delay='15ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s2, s3, port1=3, port2=1, bw=15, delay='15ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s3, s4, port1=2, port2=1, bw=15, delay='15ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s4, s5, port1=2, port2=4, bw=15, delay='15ms', loss=0, max_queue_size=1000, use_htb=True)
    ...
    root3 = net.addHost('root3', inNamespace=False, ip='10.123.123.3/32')
    intf = net.addLink(s3,root3, port1=5).intf1

    root4 = net.addHost('root4', inNamespace=False, ip='10.123.123.4/32')
    intf = net.addLink(s4,root4, port1=5).intf1

    root5 = net.addHost('root5', inNamespace=False, ip='10.123.123.5/32')
    intf = net.addLink(s5,root5, port1=5).intf1
    ...
    c3 = net.addController( 'c3', controller=RemoteController, ip=CONTROLLER_IP, port=6688)

    c4 = net.addController( 'c4', controller=RemoteController, ip=CONTROLLER_IP, port=6666)
    ...
    root1.cmd( 'route add -host 20.10.10.5 dev root1-eth0')
    root1.cmd( 'arp -s 20.10.10.5 00:00:00:00:00:09' )
    ...
    root2.cmd( 'route add -host 20.20.20.4 dev root2-eth0')
    root2.cmd( 'arp -s 20.20.20.4 00:00:00:00:00:08' )
    root2.cmd( 'route add -host 20.20.20.5 dev root2-eth0')
    root2.cmd( 'arp -s 20.20.20.5 00:00:00:00:00:09' )    
    ...
    root3.cmd( 'route add -host 20.30.30.4 dev root3-eth0')
    root3.cmd( 'arp -s 20.30.30.4 00:00:00:00:00:08' )
    root3.cmd( 'route add -host 20.30.30.5 dev root3-eth0')
    root3.cmd( 'arp -s 20.30.30.5 00:00:00:00:00:09' )

    #ips ficticios  
    root4.cmd( 'route add -host 20.40.40.1 dev root4-eth0')
    ...
    root4.cmd( 'route add -host 20.40.40.5 dev root4-eth0')
    root4.cmd( 'arp -s 20.40.40.5 00:00:00:00:00:09' )

    #ips ficticios  
    root5.cmd( 'route add -host 20.50.50.1 dev root5-eth0')
    root5.cmd( 'arp -s 20.50.50.1 00:00:00:00:00:05' )
    root5.cmd( 'route add -host 20.50.50.2 dev root5-eth0')
    root5.cmd( 'arp -s 20.50.50.2 00:00:00:00:00:06' )
    root5.cmd( 'route add -host 20.50.50.3 dev root5-eth0')
    root5.cmd( 'arp -s 20.50.50.3 00:00:00:00:00:07' )
    root5.cmd( 'route add -host 20.50.50.4 dev root5-eth0')
    root5.cmd( 'arp -s 20.50.50.4 00:00:00:00:00:08' )

    root5.cmd( 'route add -host 172.16.10.4 dev root5-eth0')
    root5.cmd( 'arp -s 172.16.10.4 b2:2c:c7:c1:72:a4' )
    ...
    h1.cmd('route add -host 10.10.10.4 dev h1-eth0')
    h1.cmd('route add -host 10.10.10.5 dev h1-eth0')
    ...
    h1.cmd('arp -s 10.10.10.3 00:00:00:00:00:07')
    h1.cmd('arp -s 10.10.10.4 00:00:00:00:00:08')
    h1.cmd('arp -s 10.10.10.5 00:00:00:00:00:09')
    ...
    h2.cmd('route add -host 10.10.10.4 dev h2-eth0')
    h2.cmd('route add -host 10.10.10.5 dev h2-eth0')
    ...
    h2.cmd('arp -s 10.10.10.4 00:00:00:00:00:08')
    h2.cmd('arp -s 10.10.10.5 00:00:00:00:00:09')
    ...
    h3.cmd('route add -host 10.10.10.4 dev h3-eth0')
    h3.cmd('route add -host 10.10.10.5 dev h3-eth0')
    ...
    h3.cmd('arp -s 10.10.10.4 00:00:00:00:00:08')
    h3.cmd('arp -s 10.10.10.5 00:00:00:00:00:09')
    ...
    h4.cmd('route add -host 10.10.10.3 dev h4-eth0')
    h4.cmd('route add -host 10.10.10.4 dev h4-eth0')
    h4.cmd('route add -host 10.10.10.5 dev h4-eth0')
    ...
    h4.cmd('arp -s 10.10.10.4 00:00:00:00:00:08')
    h4.cmd('arp -s 10.10.10.5 00:00:00:00:00:09')

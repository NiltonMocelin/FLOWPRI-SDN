...
#    CONTROLLER_IP_HOST = '172.16.10.1' # assim nao funcionou
    ...
    s6 = net.addSwitch( 's6', listenPort=6639, mac='00:00:00:00:00:06', dpid='0000000000000006',protocols="OpenFlow10,OpenFlow12,OpenFlow13")
    ...
    intf = net.addLink(s2, root1, port1=5).intf1

    root2 = net.addHost('root2', inNamespace=False, ip='10.123.123.2/32')
    intf = net.addLink(s5, root2, port1=5).intf1

...
`h1: python contrato_cli_v2.py 10.10.10.1 172.16.10.1 172.16.10.2 1000 1 >> tempo2.saida`
`root1-c1: ryu-manager c1_v2_semPrints.py --ofp-tcp-listen-port 7000 >> tempo2.saida`
`root2-c2: ryu-manager c2_v2_semPrints.py --ofp-tcp-listen-port 6699 >> tempo2.saida`

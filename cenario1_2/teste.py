...
#
from ryu.lib.ovs.bridge import OVSBridgeNotFound
#
...
#        bridge_sw = bridge.OVSBridge(CONF, datapath.id, )
#        vsctl.VSCtl._set_qos("s1-eth4",  queues=[{'min-rate': '10000', 'max-rate': '100000'},{'min-rate': '500000'}], max_rate="100000000")
#        print(vsctl.VSCtl.__dict__)
#        ovs_bridge = bridge.OVSBridge(self.CONF, datapath.id, "tcp:127.0.0.1:6653")#, datapath.id, "tcp:127.0.0.1:6653")
#        print(ovs_bridge.get_port_name_list())
### funcao com o evento para fazer a configuracao de fila ou simple_switch_rest_api


        print(ev.__dict__)

#        print(vsctl.get_port_name_list())

#        ovs_bridge.set_qos("s1-eth4",  queues=[{'min-rate': '100', 'max-rate': '1000'},{'min-rate': '5000'}], max_rate="1000000")

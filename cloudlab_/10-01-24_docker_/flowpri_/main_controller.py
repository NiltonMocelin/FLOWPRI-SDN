...
#             fp_acao.Acao(s,porta,fp_acao.REMOVER, fp_regra.Regra(i.ip_ver, i.ip_src,i.ip_dst,i.src_port, i.dst_port, 
...
#             fp_acao.Acao(switch_obj = switch,porta = int(porta_nome),codigo = fp_acao.REMOVER, regra= fp_regra.Regra(ip_ver=ip_ver, ip_src=ip_src,ip_dst=ip_dst,src_port=src_port, dst_port=dst_port, proto=proto, porta_saida = int(porta_nome), tos=tos, banda=None, prioridade=None, classe=None, emprestando=None)).executar()

...
#    CONTROLLER_IP_HOST = '172.16.10.1' # assim nao funcionou
    ...
    net = Mininet(topo=None, build=False, link=TCLink, host=CPULimitedHost, switch=OVSKernelSwitch, autoSetMacs=True, ipBase='172.16.0.0/24')

    hosts=5

    # Create nodes
    h1 = net.addHost( 'h1', mac='8e:49:d6:d3:1e:df', cpu=.5/hosts, ip='172.16.1.1/24')
    h2 = net.addHost( 'h2', mac='0e:7b:ac:84:a3:69', cpu=.5/hosts, ip='172.16.1.2/24')
    h3 = net.addHost('h3', mac='ae:f4:cf:ab:4c:15', cpu=.5/hosts, ip='172.16.1.3/24')
    h4 = net.addHost('h4', mac='b2:2c:c7:c1:72:a4', cpu=.5/hosts, ip='172.16.2.4/24')
